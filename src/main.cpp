...
uint256 hashGenesisBlock("0x512a9c69d87cc0bfb04a4d274f1e60262dd244d3c9b0aa2c236a2cfc13c19f12");
...
const string strMessageMagic = "MarihuanaCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MarihuanaCoin: 1 days
static const int64 nTargetSpacing = 120; // MarihuanaCoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal marihuanacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MarihuanaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6f1706ecffba32a7277a0e5b1444909c208208f8fdfa2b7c3897b4d0ce2da370");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Traditionally one puts something timely gere coinciding with the epoch";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393631940;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 387569677;

        if (fTestNet)
        {
            block.nTime    = 1393215600;
        ...
        assert(block.hashMerkleRoot == uint256("0x415306a56f883447d7612a01a67b891b4dd690fe7e952eccdbbf33d2c30a872e"));
